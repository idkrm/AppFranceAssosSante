        ...
        btnconnecter.setOnClickListener{
            ...
            if(user != null){
                if(motDePasse.equals(user.mdp)){
                    ...
                    Toast.makeText(context,  getString(R.string.error_message_mdp_incorrect), Toast.LENGTH_SHORT).show()
            }
            else
                Toast.makeText(context,  getString(R.string.error_message_user_non_existant), Toast.LENGTH_SHORT).show()
        }
